...
## Corpus Check
- 39 files · ~164,038 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1203 nodes · 1491 edges · 51 communities
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e91a9992`
...
- 九、团队与组织
- 相关文档和资源
- esp-dev-kits-zh_CN-master-esp32s3.md
...
4. `寿命终止开发板` - 22 edges
5. `ESP32-S3-DevKitC-1` - 20 edges
6. `ESP32-S3-USB-OTG` - 20 edges
7. `main()` - 19 edges
8. `serialize_v2()` - 17 edges
9. `竞品研究 (5/5) — 手部数据/骨架格式与流协议互操作` - 17 edges
10. `ESP32-P4X-Function-EV-Board` - 17 edges
...
Cohesion: 0.08
Nodes (83): IntEnum, _canonical_quat(), crc16_modbus(), _f16(), _f16_bits(), _f32(), fk21(), HandSkeleton (+75 more)

### Community 2 - "Chapter 4"
Cohesion: 0.06
Nodes (35): 3. 通过 电池供电, 3. 通过 电池供电, 4.1.1 入门指南, 4.1.2 硬件参考, 4.1.3 硬件版本, 4.1.4 相关文档, 4.1 ESP-VoCat v1.2, 5.1.1 入门指南 (+27 more)
...
### Community 49 - "相关文档和资源"
Cohesion: 0.29
Nodes (7): 7.1 相关文档, 7.2 开发者社区, 7.3 产品, 7.4 联系我们, Chapter 8, 免责声明和版权公告, 相关文档和资源

### Community 50 - "esp-dev-kits-zh_CN-master-esp32s3.md"
Cohesion: 0.50
Nodes (3): Chapter 2, Chapter 7, Table of contents
...
- **Why does `Chapter 4` connect `Chapter 4` to `esp-dev-kits-zh_CN-master-esp32s3.md`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `寿命终止开发板` connect `寿命终止开发板` to `esp-dev-kits-zh_CN-master-esp32p4.md`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `ESP32-S3-USB-OTG` connect `ESP32-S3-USB-OTG` to `esp-dev-kits-zh_CN-master-esp32s3.md`?**
...
- **Should `test_hand_token.py` be split into smaller, more focused modules?**
  _Cohesion score 0.07671745522587543 - nodes in this community are weakly interconnected._
